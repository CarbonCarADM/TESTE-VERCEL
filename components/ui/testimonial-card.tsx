...
const StickyTestimonialCard: React.FC<{ testimonial: Testimonial; index: number }> = ({ testimonial, index }) => {
  return (
    <div
      ...
      // Cards menores e empilhamento com offset menor para visibilidade
      style={{ 
        top: `${120 + index * 40}px`, 
        zIndex: 10 + index 
      }}
    >
      <motion.div 
        ...
        className={cn(
          ...
          "hover:border-red-600/30 group mb-20" // Margem menor para manter a pilha visível no topo
        )}
      >
...
export const ClientsSection = ({
  ...
  // Altura calculada para permitir o scroll de todos os cards
